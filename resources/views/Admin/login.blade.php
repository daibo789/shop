...
<link href="/style/Admin/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin" />
...
<script src="/style/Admin/js/bootstrap.min.js" type="text/javascript"></script>
...
<body class="login_style login-layout">
 <div class="loginbody">
  <div class="login-container">
   <div class="login_logo"><img src="/style/Home//style/Home/images/logo.png" /></div>
    <div class="position-relative">
     <div id="login_add" class="login-box widget-box no-border visible">
      ...
      <div class="clearfix">
       <div class="login_icon"><img src="/style/Home//style/Home/images/login_bg.png" /></div>
